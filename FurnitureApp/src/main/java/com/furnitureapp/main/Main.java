		...
		do {
			...
			if(choose==1) {
			  ...
			  case 1:   
				...
				System.out.println("Enter type\t0.TWOSOFA\t1.FOURSOFA\t2.BEDS\t3.SINGLEBED\n4.TABLES\t5.CENTERTABLE\t6.CHAIRS\t7.STUDYCHAIR  8.RACKS");
			    choose=sc.nextInt();
				sc.nextLine();
				...
				sc.nextLine();
				Furniture furniture=new Furniture(furnitureid,furnitureName,material,type,category,shape,price);
			...
			default:
				...
				if(setChoice==1) {
				    ...
				    System.out.println("please enter your password");
				    String password=sc.nextLine();
				    User userList=new User(username,name,mobileNo,email,city,password);
				    System.out.println(userService.register(userList));
